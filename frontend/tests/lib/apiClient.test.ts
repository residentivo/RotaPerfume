...
import { MSG_VENDEDOR_DESLIGADO } from "@/lib/vendedorDesligado";
...
type VendedorDesligadoModule = typeof import("@/lib/vendedorDesligado");
...
beforeEach(async () => {
  ...
  vd = await import("@/lib/vendedorDesligado");
  client = await import("@/lib/apiClient");
