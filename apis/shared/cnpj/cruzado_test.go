...
// testdata/casos_cruzados.json é a MESMA lida por
// frontend/src/lib/cnpj.cruzado.test.ts; os dois lados precisam dar o mesmo
...
func carregarMassaCruzada(t *testing.T) massaCruzada {
	t.Helper()
	raw, err := os.ReadFile(filepath.Join("testdata", "casos_cruzados.json"))
